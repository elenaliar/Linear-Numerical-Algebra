...
%disp(b);
minradius = +Inf;
fprintf("Calculating solution of linear system Ax=b with PSD method and using x0=b\n");
for t=0.1:0.1:1.9
    for w=0.1:0.1:1.9
        radius = calculate_r_psd(A,n, t, w);
...
starttime = tic;
[x, itcount] = psd_find_sol(A, n, topt, wopt, maxiter, b);
endtime = toc;
